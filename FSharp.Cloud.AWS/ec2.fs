...
module FEc2 =
        ...
        let createRoute (c : AmazonEC2Client) routeTableId internetGatewayId destCidrBlock =               
                new CreateRouteRequest(RouteTableId=routeTableId, GatewayId=internetGatewayId, 
                                       DestinationCidrBlock=destCidrBlock) |> c.CreateRoute
